...
def main(configfile, dataset_name):
    ...
    # Remove auxiliary and hard-remove features based on the YAML config
    ...
    # Select only numeric features and explicitly exclude 'account_id'
    feature_cols = [
    ...
    # Train a more conservative Random Forest
